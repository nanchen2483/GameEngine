...
void main()
{
	...
	vec2 t00 = cTexCoord[0];
    vec2 t01 = cTexCoord[1];
    vec2 t10 = cTexCoord[2];
    vec2 t11 = cTexCoord[3];

    vec2 t0 = (t01 - t00) * u + t00;
    vec2 t1 = (t11 - t10) * u + t10;
    vec2 texCoord = (t1 - t0) * v + t0;

	eHeight = texture(uHeightMap, texCoord).r * 64.0f - 16.0f;
	...
	vec4 position = (p1 - p0) * v + p0 + normal * eHeight;
